...
const DashboardHeader = () => {
  return (
    <div className="flex w-full flex-row items-center border-b-[1px] border-black/5 p-4 pl-6">
      <div className="flex h-10 w-96 items-center rounded-lg bg-gray-200">
      ...
      <div className="ml-auto flex items-center justify-center rounded-full p-1 transition-colors duration-300 hover:bg-black/10">
        <Avatar.Root className="inline-flex size-[45px] cursor-pointer select-none items-center justify-center overflow-hidden rounded-full bg-black/10 align-middle">
          <Avatar.Fallback className="leading-1 flex size-full items-center justify-center bg-green-200 text-[15px] font-medium text-green-700">
            RC
          </Avatar.Fallback>
        </Avatar.Root>
      </div>
